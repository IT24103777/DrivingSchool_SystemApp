...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="flex items-center mb-6">
        <a href="${pageContext.request.contextPath}/admin" class="mr-4 text-blue-600 hover:text-blue-800">
    ...
    <form id="adminForm" class="hidden bg-white shadow rounded-lg p-6">
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                <label for="adminNumber" class="block text-sm font-medium text-gray-700 mb-1">Admin Number</label>
                <input type="text" id="adminNumber" name="adminNumber" required readonly
                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100"
                       pattern="^ADM\d{4}$"
                       title="Admin number should be in format ADM0000">
            </div>
            ...
            <div class="flex justify-end space-x-3">
                <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/admin'"
...
<script>
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        if (!adminId || isNaN(adminId)) {
            showAlert('Invalid admin ID provided', 'error');
        ...
        try {
            ...
            const response = await fetch(`${pageContext.request.contextPath}/api/admins/`+adminId);
    ...
    document.getElementById('adminForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${pageContext.request.contextPath}/api/admins/`+formData.id, {
                method: 'PUT',
                headers: {
    ...
    function populateForm(admin) {
        ...
        document.getElementById('adminNumber').value = admin.adminNumber;
        document.getElementById('contactNumber').value = admin.contactNumber;
        document.getElementById('email').value = admin.email;
        document.getElementById('nic').value = admin.nic;
    }
