...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="flex items-center mb-6">
        <a href="/admin" class="mr-4 text-blue-600 hover:text-blue-800">
    ...
    <form id="adminForm" class="bg-white shadow rounded-lg p-6">
    ...
    document.getElementById('adminForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                showAlert(error.error || 'Failed to create admin', 'error');
            }
        } catch (error) {
