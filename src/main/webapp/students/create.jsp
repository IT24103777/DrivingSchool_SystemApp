...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    ...
    <form id="studentForm" class="bg-white shadow rounded-lg p-6">
...
<script>
    document.getElementById('studentForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await fetch('${pageContext.request.contextPath}/api/students', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                showAlert(error.error || 'Failed to create student', 'error');
            }
        } catch (error) {
            console.error(error)
