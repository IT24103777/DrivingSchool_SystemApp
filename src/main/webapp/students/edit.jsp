...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="flex items-center mb-6">
        <a href="${pageContext.request.contextPath}/student-list" class="mr-4 text-blue-600 hover:text-blue-800">
    ...
    <form id="studentForm" class="hidden bg-white shadow rounded-lg p-6">
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <input type="text" id="studentNumber" name="studentNumber" required readonly
                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100"
                       pattern="^STU\d{4}$"
                       title="Student number should be in format STU0000">
            </div>

            <div>
                <label for="contactNumber" class="block text-sm font-medium text-gray-70 mb-1">Contact Number</label>
            ...
            <div class="flex justify-end space-x-3">
                <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/student-list'"
...
<script>
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        if (!studentId || isNaN(studentId)) {
            showAlert('Invalid student ID provided', 'error');
        ...
        try {
            ...
            const response = await fetch(`${pageContext.request.contextPath}/api/students/`+studentId);
    ...
    document.getElementById('studentForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${pageContext.request.contextPath}/api/students/`+formData.id, {
                method: 'PUT',
                headers: {
